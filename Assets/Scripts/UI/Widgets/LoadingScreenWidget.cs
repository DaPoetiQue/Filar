...
namespace Com.RedicalGames.Filar
{
    public class LoadingScreenWidget : AppData.Widget
    {
        ...
        {
            AppData.CallbackData<AppData.WidgetStatePacket<AppData.WidgetType, AppData.WidgetType>> callbackResults = new AppData.CallbackData<AppData.WidgetStatePacket<AppData.WidgetType, AppData.WidgetType>>();
