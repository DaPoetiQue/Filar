...
namespace Com.RedicalGames.Filar
{
    public class AppDatabaseManager : AppData.SingletonBaseComponent<AppDatabaseManager>
    {
        ...
        {
            var callbackResults = new AppData.CallbackData<AppData.Folder>();
        ...
        public async Task<AppData.Callback> DownloadInitialPostContentAsync(AppData.ScreenType screenType)
        {
            ...
            if (callbackResults.Success())
            {
                ...
                while (postManagerInstance.HasPost == false)
                    await Task.Yield();
                ...
                if (callbackResults.Success())
                {
                    ...
                    if (callbackResults.Success())
                    {
                        ...
                        if (callbackResults.Success())
                        {
                            ...
                            var clearContainerCallbackResultsTask = await container.ClearAsync(true);
            ...
            if (GetProjectStructureData().Success())
            {
                ...
                switch (GetProjectStructureData().data.GetPaginationViewType())
                {
                    case AppData.PaginationViewType.Pager:
                        ...
                        ScreenUIManager.Instance.GetCurrentScreen().GetData().HideWidget(AppData.WidgetType.ScrollerNavigationWidget);
                    ...
                    case AppData.PaginationViewType.Scroller:
                        ...
                        ScreenUIManager.Instance.GetCurrentScreen().GetData().HideWidget(AppData.WidgetType.PagerNavigationWidget);
